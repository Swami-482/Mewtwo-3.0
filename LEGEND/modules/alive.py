...
# inline by LEGENDX22 and PROBOYX🔥
  PROBOYX = [[Button.url("REPO-KIRITO", "https://github.com/kanekiken44/KIRITO")]]
...
async def repo(event):
  await tbot.send_message(event.chat, "REPO OF KIRITO", buttons=[[Button.url("🛡REPO🛡", "https://github.com/kanekiken44/KIRITO")]])
# PROBOYX 🔥 LEGENDX22
